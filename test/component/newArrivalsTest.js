describe("New Arrivals Component Test", function () {
  ...
  before(async () => {
    component = await browser.mountVueComponent(
      "/src/components/new-arrivals/NewArrivals.vue",
      {
        plugins: {
              ...
              books: [
                {
                  ...
                  description:
                    "На безымянном острове исчезают предметы: сначала шляпы, потом ленты, птицы, розы...",
                },
              ],
            },
          },
  ...
  it("tests the component", function (browser) {
    ...
    expect(component).text.toContain("Полиция памятиe");
